...
@SuppressWarnings({"unused", "WeakerAccess"}) public class LottieAnimationView extends ImageView {
  ...
  private Set<LottieOnCompositionLoadedListener> lottieOnCompositionLoadedListeners = new HashSet<LottieOnCompositionLoadedListener>();
   ...
   */
  public void setAnimation(JsonReader reader, String cacheKey) {
