...
public class PerformanceTracker {
  ...
  private final Set<FrameListener> frameListeners = new HashSet<FrameListener>();
  private final Map<String, MeanCalculator> layerRenderTimes = new HashMap<String, MeanCalculator>();
  ...
  public List<Pair<String, Float>> getSortedRenderTimes() {
    ...
    List<Pair<String, Float>> sortedRenderTimes = new ArrayList<Pair<String, Float>>(layerRenderTimes.size());
    for (Map.Entry<String, MeanCalculator> e : layerRenderTimes.entrySet()) {
      sortedRenderTimes.add(new Pair<String, Float>(e.getKey(), e.getValue().getMean()));
    }
