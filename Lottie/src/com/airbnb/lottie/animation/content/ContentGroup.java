...
public class ContentGroup implements DrawingContent, PathContent,
  ...
  private static List<Content> contentsFromModels(LottieDrawable drawable, BaseLayer layer,
    ...
    List<Content> contents = new ArrayList<Content>(contentModels.size());
  ...
  ContentGroup(final LottieDrawable lottieDrawable, BaseLayer layer,
      String name, List<Content> contents, AnimatableTransform transform) {
    this.name = name;
    ...
    List<GreedyContent> greedyContents = new ArrayList<GreedyContent>();
  ...
  @Override public void setContents(List<Content> contentsBefore, List<Content> contentsAfter) {
    ...
    List<Content> myContentsBefore = new ArrayList<Content>(contentsBefore.size() + contents.size());
  ...
  List<PathContent> getPathList() {
    if (pathContents == null) {
      pathContents = new ArrayList<PathContent>();
