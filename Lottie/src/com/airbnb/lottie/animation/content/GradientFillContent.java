...
public class GradientFillContent
  ...
  private final LongSparseArray<LinearGradient> linearGradientCache = new LongSparseArray<LinearGradient>();
  private final LongSparseArray<RadialGradient> radialGradientCache = new LongSparseArray<RadialGradient>();
     ...
     if (property == LottieProperty.COLOR_FILTER) {
       if (callback == null) {
         ...
         colorFilterAnimation =
             new ValueCallbackKeyframeAnimation<ColorFilter, ColorFilter>((LottieValueCallback<ColorFilter>) callback);
