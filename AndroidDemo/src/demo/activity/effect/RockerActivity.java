...
public class RockerActivity extends Activity {
	...
	private class RockerSurfaceView extends SurfaceView implements Callback, Runnable {
		...
		public RockerSurfaceView(Context context) {
			...
			SmallRockerCircleX = RockerCircleX = getResources().getDisplayMetrics().widthPixels / 2;
			SmallRockerCircleY = RockerCircleY = getResources().getDisplayMetrics().heightPixels / 2;
		}
