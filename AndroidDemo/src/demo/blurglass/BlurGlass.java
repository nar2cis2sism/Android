...
public class BlurGlass {
    
    @SuppressLint("InlinedApi")
    public static Bitmap apply(Context context, Bitmap src, float radius) {
        Bitmap image = src.copy(src.getConfig(), true);
        if (image == null)
        {
            image = Bitmap.createBitmap(src.getWidth(), src.getHeight(), src.getConfig());
        ...
        {
            blur(image, Math.round(radius));
        }
        
        return image;
    }
    
    private static void blur(Bitmap image, int radius)
    {
